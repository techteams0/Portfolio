  ...
  return(
    <>
       ...
       <Head>
           ...
           <title>TechTeams | About Page</title>
       ...
       <main className='flex w-full flex-col items-center justify-center dark:text-light'>
          ...
          <AnimatedText text="Passion Fuels Purpose!" className="md-16 lg:!text-7xl sm:!text-6xl xs:!text-4xl sm:mb-8" />
...
<div className='col-span-3 relative h-max rounded-2xl border-2 border-solid border-dark bg-light p-8 dark:bg-dark dark:border-light xl:col-span-4 md:order-1 md:col-span-8'>
 ...
 <div className='col-span-2 flex flex-col items-end justify-between xl:col-span-8 xl:flex-row xl:items-center md:order-3' >
    <div className='flex flex-col iteams-end justify-center xl:items-center'>

        <span className='inline-block text-7xl font-bold md:text-6x1 sm:text-5x1 xs:text-light-4x1'>
    ...
    <div className='flex flex-col iteams-end justify-center'>
